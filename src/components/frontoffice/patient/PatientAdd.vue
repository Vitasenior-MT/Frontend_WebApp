        ...
        <v-container grid-list-md>
          <v-layout wrap>
            ...
            <v-flex xs12 class="pt-1">
              <label class="primary--text">info:</label> The patient can only use the system through the vitabox after being assigned to a doctor, who should initiates his activity.
            </v-flex>
            <v-flex sx12>
